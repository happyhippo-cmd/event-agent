...
export const ALBUMS = [
  { id: 'a1', title: '소문의 낙원', artist: 'AKMU', cover: '/assets/album-covers/akmu-paradise-of-rumors.jpg', vibe: '기묘한 · 자유로운', vibeEn: 'Mysterious · Free-spirited',
  ...
  { id: 'a2', title: '0+0', artist: 'HANRORO', cover: '/assets/album-covers/hanroro-0-plus-0.jpg', vibe: '청춘의 · 선명한', vibeEn: 'Youthful · Vivid',
  ...
  { id: 'a3', title: 'Love wins all', artist: 'IU', cover: '/assets/album-covers/iu-love-wins-all.jpg', vibe: '애틋한 · 시네마틱한', vibeEn: 'Tender · Cinematic',
  ...
  { id: 'a4', title: 'RedRed', artist: 'CORTIS', cover: '/assets/album-covers/cortis-redred.jpg', vibe: '날것의 · 강렬한', vibeEn: 'Raw · Intense',
  ...
  { id: 'a5', title: '404', artist: 'KiiiKiii', cover: '/assets/album-covers/kiiikiii-404.jpg', vibe: '디지털 · 쿨한', vibeEn: 'Digital · Cool',
  ...
  { id: 'a6', title: '이브, 프시케, 그리고 푸른 수염의 아내', artist: 'LE SSERAFIM', cover: '/assets/album-covers/lesserafim-eve.jpg', vibe: '당당한 · 대담한', vibeEn: 'Confident · Bold',
  ...
  { id: 'a7', title: '붉은 노을', artist: 'BIGBANG', cover: '/assets/album-covers/bigbang-sunset-glow.jpg', vibe: '레트로 · 벅찬', vibeEn: 'Retro · Overwhelming',
  ...
  { id: 'a8', title: 'RUDE!', artist: 'Hearts2Hearts', cover: '/assets/album-covers/hearts2hearts-rude.jpg', vibe: '키치한 · 발랄한', vibeEn: 'Kitschy · Playful',
  ...
  { id: 'a9', title: 'Drowning', artist: 'WOODZ', cover: '/assets/album-covers/woodz-drowning.jpg', vibe: '몰입감 있는 · 애절한', vibeEn: 'Immersive · Heartfelt',
  ...
  { id: 'a10', title: 'Body to Body', artist: 'BTS', cover: '/assets/album-covers/bts-body-to-body.jpg', vibe: '감각적 · 리드미컬한', vibeEn: 'Sensual · Rhythmic',
  ...
  { id: 'a11', title: 'Blue Valentine', artist: 'NMIXX', cover: '/assets/album-covers/nmixx-blue-valentine.jpg', vibe: '블루한 · 다이내믹한', vibeEn: 'Blue-toned · Dynamic',
  ...
  { id: 'a12', title: '뛰어', artist: 'BLACKPINK', cover: '/assets/album-covers/blackpink-jump.jpg', vibe: '폭발적인 · 런웨이 같은', vibeEn: 'Explosive · Runway-like',
  ...
  { id: 'a13', title: 'Golden', artist: 'HUNTR/X', cover: '/assets/album-covers/huntrx-golden.jpg', vibe: '영웅적인 · 반짝이는', vibeEn: 'Heroic · Sparkling',
  ...
  { id: 'a14', title: 'Happy', artist: 'DAY6', cover: '/assets/album-covers/day6-happy.jpg', vibe: '따뜻한 · 벅찬', vibeEn: 'Warm · Overwhelming',
  ...
  { id: 'a15', title: 'Catch Catch', artist: 'YENA', cover: '/assets/album-covers/yena-catch-catch.jpg', vibe: '키치한 · 통통 튀는', vibeEn: 'Kitschy · Bouncy',
  ...
  { id: 'a16', title: 'Sticky', artist: 'NCT WISH', cover: '/assets/album-covers/nct-wish-sticky.jpg', vibe: '달콤한 · 트로피컬한', vibeEn: 'Sweet · Tropical',
  ...
  { id: 'a17', title: 'Sugar Rush Ride', artist: 'TXT', cover: '/assets/album-covers/txt-sugar-rush-ride.jpg', vibe: '달콤한 · 몽환적인', vibeEn: 'Sweet · Dreamy',
  ...
  { id: 'a18', title: 'REBEL HEART', artist: 'IVE', cover: '/assets/album-covers/ive-rebel-heart.jpg', vibe: '당당한 · 찬란한', vibeEn: 'Confident · Radiant',
  ...
  { id: 'a19', title: 'Rooftop', artist: 'N.Flying', cover: '/assets/album-covers/nflying-rooftop.jpg', vibe: '청량한 · 벅찬', vibeEn: 'Refreshing · Overwhelming',
  ...
  { id: 'a20', title: 'Antifreeze', artist: 'The Black Skirts', cover: '/assets/album-covers/black-skirts-antifreeze.jpg', vibe: '나른한 · 빈티지한', vibeEn: 'Laid-back · Vintage',
  ...
  { id: 'a21', title: 'Into the New World', artist: "Girls' Generation", cover: '/assets/album-covers/girls-generation-into-the-new-world.jpg', vibe: '희망찬 · 찬란한', vibeEn: 'Hopeful · Radiant',
  ...
  { id: 'a22', title: 'The Chaser', artist: 'INFINITE', cover: '/assets/album-covers/infinite-the-chaser.jpg', vibe: '극적인 · 질주하는', vibeEn: 'Dramatic · Rushing',
  ...
  { id: 'a23', title: '피차일반', artist: '음율', cover: '/assets/album-covers/eumyul-each-other.jpg', vibe: '서정적인 · 단정한', vibeEn: 'Lyrical · Neat',
  ...
  { id: 'a24', title: '정말 오래도 걸렸네', artist: 'Yudabinband', cover: '/assets/album-covers/yudabinband-long-time.jpg', vibe: '담담한 · 벅찬', vibeEn: 'Calm · Overwhelming',
  ...
  { id: 'a25', title: 'Bounce', artist: 'Cho Yong Pil', cover: '/assets/album-covers/cho-yong-pil-bounce.jpg', vibe: '경쾌한 · 클래식한', vibeEn: 'Lighthearted · Classic',
  ...
  { id: 'a26', title: 'T.B.H', artist: 'QWER', cover: '/assets/album-covers/qwer-tbh.jpg', vibe: '싱그러운 · 풋풋한', vibeEn: 'Fresh · Young',
  ...
  { id: 'a28', title: 'Super', artist: 'SEVENTEEN', cover: '/assets/album-covers/seventeen-super.jpg', vibe: '웅장한 · 에너제틱한', vibeEn: 'Grand · Energetic',
  ...
  { id: 'a29', title: 'NO PAIN', artist: 'Silica Gel', cover: '/assets/album-covers/silica-gel-no-pain.jpg', vibe: '사이키델릭 · 폭발적인', vibeEn: 'Psychedelic · Explosive',
  ...
  { id: 'a30', title: '그때 그 사람', artist: '심수봉', cover: '/assets/album-covers/sim-soo-bong-the-man-at-then.jpg', vibe: '레트로 · 애잔한', vibeEn: 'Retro · Bittersweet',
  ...
  { id: 'a31', title: 'Aqua Man', artist: 'Beenzino', cover: '/assets/album-covers/beenzino-aqua-man.jpg', vibe: '쿨한 · 도회적인', vibeEn: 'Cool · Urban',
  ...
  { id: 'a32', title: '스물다섯, 스물하나', artist: 'JAURIM', cover: '/assets/album-covers/jaurim-twenty-five-twenty-one.jpg', vibe: '청춘의 · 아련한', vibeEn: 'Youthful · Nostalgic',
  ...
  { id: 'a33', title: 'Gangnam Style', artist: 'PSY', cover: '/assets/album-covers/psy-gangnam-style.jpg', vibe: '축제적인 · 유쾌한', vibeEn: 'Festive · Cheerful',
  ...
  { id: 'a34', title: 'Touch', artist: 'KATSEYE', cover: '/assets/album-covers/katseye-touch.jpg', vibe: '글로벌 · 산뜻한', vibeEn: 'Global · Crisp',
